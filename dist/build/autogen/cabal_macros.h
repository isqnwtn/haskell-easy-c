...
/* package easy-c-0.1.0.0 */
#define VERSION_easy_c "0.1.0.0"
#define MIN_VERSION_easy_c(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "easy-c-0.1.0.0"

#define CURRENT_PACKAGE_KEY "easy-c-0.1.0.0"
